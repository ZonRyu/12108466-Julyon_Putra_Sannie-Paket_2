                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="{{ Route('func-login') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label for="username" class="form-label">Username</label>
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Bambang" tabindex="1" autofocus />
                                    </div>
